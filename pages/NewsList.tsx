...
export const NewsList: React.FC<NewsListProps> = ({ news: _news }) => {
  return (
...
// Contenido anterior de Noticias, comentado para reactivarlo mas adelante.
//
...
//           <p className="text-fepucv-textSecondary text-lg">Ent̩rate de todo lo que ocurre en nuestra comunidad universitaria.</p>
//         </div>
//
//         {/* Filters */}
