...
export const CHARACTERS: Character[] = [
  ...
  { id: 3, name: 'Mirko', role: 'Vicepresidencia', img: '/img/mesa/mirko_pena.jpeg' },
  { id: 4, name: 'Romina', role: 'Secretaria de Bienestar y Extensión', img: '/img/mesa/romina_farias.jpeg' },
  { id: 5, name: 'Sofía', role: 'Presidencia', img: '/img/mesa/sofia_venegas.jpeg' },
  { id: 6, name: 'Vincent', role: 'Secretaría de Finanzas', img: '/img/mesa/vincent_munos.jpeg' },
];
